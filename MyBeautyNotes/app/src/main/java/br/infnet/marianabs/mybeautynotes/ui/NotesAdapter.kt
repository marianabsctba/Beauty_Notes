...
import br.infnet.marianabs.mybeautynotes.databinding.NoteLayoutBinding
...
class NotesAdapter : ListAdapter<Notes, NotesAdapter.NotesViewHolder>(NotesDiffCallback()) {
    ...
    class NotesViewHolder private constructor(val binding: NoteLayoutBinding)
        ...
        fun bind(item:Notes) {
           ...
           companion object {
               fun from(parent: ViewGroup): NotesViewHolder {
                   ...
                   val binding = NoteLayoutBinding.inflate(layoutInflater,
                       parent, false)
