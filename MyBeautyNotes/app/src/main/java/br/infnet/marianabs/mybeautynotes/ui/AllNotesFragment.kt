...
import br.infnet.marianabs.mybeautynotes.viewmodel.NotesViewModel
import br.infnet.marianabs.mybeautynotes.databinding.FragmentAllNotesBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val itemTouchHelperCallback = object :
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                if (mNote != null) {
                    Snackbar.make(view, "Lembrete excluído com sucesso!", Snackbar.LENGTH_LONG)
                        .setAction("Desfazer") {
